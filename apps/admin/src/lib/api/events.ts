...
export const Event = {
  ...
  CONTENT_PULL_SOURCE: 'CONTENT_PULL_SOURCE',
  CONTENT_IMPORT_MARKDOWN: 'CONTENT_IMPORT_MARKDOWN',

  // 主站数据
  DATA_SAVE: 'DATA_SAVE',
  FEEDS_REFRESH: 'FEEDS_REFRESH',
  MEMOS_SYNC: 'MEMOS_SYNC',
  ...
  THEME_SETTINGS_SAVE: 'THEME_SETTINGS_SAVE',
  COMMENT_SETTINGS_SAVE: 'COMMENT_SETTINGS_SAVE',
...
export const MUTATION_EVENTS: ReadonlySet<string> = new Set([
  ...
  Event.CONTENT_PULL_SOURCE,
  Event.CONTENT_IMPORT_MARKDOWN,
  Event.DATA_SAVE,
  Event.FEEDS_REFRESH,
  Event.MEMOS_SYNC,
  Event.IMAGE_UPLOAD,
  ...
  Event.CONFIG_UPDATE,
  Event.THEME_SETTINGS_SAVE,
  Event.COMMENT_SETTINGS_SAVE
]);
