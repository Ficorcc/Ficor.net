...
description: 本文将介绍如何将 Hexo 博客迁移到 Astro 博客，只需要 1 分钟即可完成！作为 Hexo 的长期用户，我在 2024 年开始尝试 Astro，被其现代化开发体验深深吸引
date: 2025-04-07
tags: ["Hexo", "Astro", "静态博客"]
slug: cong-hexo-dao-astro-bo-ke-1-fen-zhong-qian-yi-zhi-nan
draft: false
archive: true
---
